...
künstlich vergrößert (Details finden sich in \cref{sec:sperren}). Zum Vergleich:
\textls[50]{\textsc{kapitälchen}}.
...
hervorstechen. Bei Akronymen, die Zahlen enthalten (wie \acr[C-3PO]{C-\kern-1pt3PO}
oder \acr[BWV 29]{BW\kern-.3px V\,29}), müssen dann aber \emph{Minuskelziffern} (siehe
\cref{sec:Ziffern}) verwendet werden, sonst erhält man
\acr[C-3PO]{C-\kern-1pt\figureversion{lf}{3}PO} und
\acr[BWV 29]{BW\kern-.3px V\,\figureversion{lf}{29}}.
