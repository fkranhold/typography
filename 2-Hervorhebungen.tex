...
\todo{auch \texttt{\textbackslash emph} erwähnen?}
...
\marginnote{\texttt{\textbackslash textbf}}Eine heutzutage sehr verbreitete, aber noch gar nicht so alte Methode der
