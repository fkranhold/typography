...
hervorstechen. Bei Akronymen, die Zahlen enthalten (wie \acr{C-\kern-1pt3PO}
oder \acr{BW\kern-.3px V\,29}), müssen dann aber \emph{Minuskelziffern} (siehe
\cref{sec:Ziffern}) verwendet werden, sonst erhält man
\acr{C-\kern-1pt\figureversion{lf}{3}PO} und
