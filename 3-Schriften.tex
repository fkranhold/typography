...
\item Eine Schrift mit »normalen«, nicht betonten Serifen heißt
  \emph{Antiqua} oder englisch \emph{\foreignlanguage{british}{serif}}
  (ja, der Name der Hauptschriftgruppe ist derselbe wie der der
  Gattung; diese Schriftarten waren nämlich die ursprünglichen
  Antiqua-Schriften).  Nach ihrem historischen Entstehungszeitpunkt
  werden die folgenden drei Schriftuntergruppen unterschieden:
  \begin{itemize}
  ...
  \end{itemize}
\item Eine Schrift mit betonten Serifen heißt \emph{Egyptienne} oder
...
\item Eine Schrift ohne Serifen heißt \emph{Grotesk} oder englisch (ja
...
ohne Boden; wir gehen nicht weiter darauf ein.
