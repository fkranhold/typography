...
dass dieser Wert zwischen 60 und 80 Zeichen pro Zeile beträgt, da ansonsten die
...
Laufweite der Schriftart abhängt.\looseness-1
...
nicht-triviales Optimierungsproblem dar. Für dieses nutzt man in \LaTeX\ am
...
\end{enumerate}
auszusuchen, zu testen, ob sie gut zusammenpassen, und dann ausschließlich diese
...
werden sollen, liegt die Versuchung nahe, für jede eine individuelle
Hervorhebungsart und einen eigenen Schriftgrad zu verwenden. Es ist jedoch oft
ansprechender, wenn mehrere Elemente auf die gleiche Weise gesetzt werden.
