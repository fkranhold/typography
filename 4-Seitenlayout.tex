...
\begin{table}
  ...
  \caption{Anteil am Flächeninhalt und Zeilenlängen (für \acr{DIN A4}, \acr{DIN
    ...
    Auslegung würde bei \acr{DIN A4} kein Rasterfaktor über 7 infrage kommen.}\label{tab:Papier}
\end{table}
...
Satzspiegels ein Vielfaches der Zeilenhöhe\todo{plus Zeilenabstand?} beträgt. In
